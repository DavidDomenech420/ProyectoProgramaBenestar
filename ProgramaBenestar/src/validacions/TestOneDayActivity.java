...
public class TestOneDayActivity {
    ...
    public static void testConstructor(){
        ...
        OneDayActivity oda1 = new OneDayActivity("Trip to the mountains", LocalDate.of(2024, 10, 1), LocalDate.of(2024, 9, 15), collectives,30, "Barcelona", LocalDate.of(2024, 10, 5), LocalTime.of(9, 0), LocalTime.of(17, 0), 50.0);
        System.out.println(oda1);
        OneDayActivity oda2 = new OneDayActivity("Trip to the beach", LocalDate.of(2026, 8, 1), LocalDate.of(2024, 8, 10), collectives,25, "Sitges", LocalDate.of(2024, 8, 15), LocalTime.of(10, 0), LocalTime.of(18, 0), 30.0);
        System.out.println(oda2);
    }

    public static void testGettersSetters(){
        String[] collectives = {"PDI", "PTGAS"};
        OneDayActivity oda2 = new OneDayActivity("City Tour", LocalDate.of(2024, 10, 1), LocalDate.of(2024, 10, 10), collectives, 20, "Madrid", LocalDate.of(2024, 10, 5), LocalTime.of(9, 0), LocalTime.of(17, 0), 40.0);
    ...
    public static void testAddInscription(){
        ...
        OneDayActivity oda3 = new OneDayActivity("Beach Day", LocalDate.of(2024, 7, 1), LocalDate.of(2024, 7, 10), collectives, 15, "Valencia", LocalDate.of(2024, 7, 5), LocalTime.of(10, 0), LocalTime.of(18, 0), 20.0);
